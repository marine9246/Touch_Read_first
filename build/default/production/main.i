...
void main(void)
{
 ...
 InitPulsePositionTable( 0 );
 InitPulsePositionTable( 1 );

 SetMotorDirection( 0, 1 );
 SetMotorStepCounter( 0, 80 );
 SetMotorAddShakePulse( 0, 0 );
 SetMotorFrequency( 0, FREQ_SET_SELF_CONTROL_NORMAL, 41 );

 SetMotorDirection( 1, 1 );
 SetMotorStepCounter( 1, 120 );
 SetMotorAddShakePulse( 1, 0 );
 SetMotorFrequency( 1, FREQ_SET_SELF_CONTROL_NORMAL, 41 );
