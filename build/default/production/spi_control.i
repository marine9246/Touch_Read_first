...
enum ID_CMD_TYPE {
    ...
    ID_CMD_FWD_NORMAL = 1,
    ID_CMD_REV_NORMAL = 2,
    ID_CMD_FWD_WITH_SHAKE = 3,
    ID_CMD_SEARCH_LOAD_POSITION = 4,
    ID_CMD_SEARCH_BASE_POSITION = 5,
    ID_CMD_FWD_WITH_CORRECT = 6,
 ID_CMD_FWD_POSITION_CTL = 7,
 ID_CMD_REV_POSITION_CTL = 8,
 ID_CMD_START_DETECT_VRS = 9,
 ID_CMD_STOP_DETECT_VRS = 10,
 ID_CMD_ENABLE_EXCITATING = 11,
 ID_CMD_DISABLE_EXCITATING = 12,
 ID_CMD_SEARCH_1008_POSITION = 13,
    ID_CMD_TYPE_MAX
};
enum ID_CMD_MOTOR {
    ID_CMD_M0 = 0xB0,
...
static void ( * const SpiCmmandFunction[ ID_CMD_TYPE_MAX ] )( UB motor_no ) = {
    ...
    SpiCmdFunc_FwdPulseNormal,
    SpiCmdFunc_RevPulseNormal,
    SpiCmdFunc_FwdPulseWithShake,
    SpiCmdFunc_SearchLoadPosition,
    SpiCmdFunc_SearchBasePosition,
    SpiCmdFunc_FwdPulseWithCorrect,
    SpiCmdFunc_FwdPulsePositionCtl,
    SpiCmdFunc_RevPulsePositionCtl,

 SpiCmdFunc_StartDetectVrs,
 SpiCmdFunc_StopDetectVrs,
 SpiCmdFunc_EnableExcitating,
 SpiCmdFunc_DisableExcitating,
 SpiCmdFunc_Search1008Position
};
# 173 "spi_control.c"
...
void SpiCmdFunc_FwdPulseNormal( UB motor_no )
{
 SetDriveType( motor_no, DRIVE_SIMPLE );
    ...
    SetMotorStepCounter( motor_no, 1 );

    SetMotorFrequency( motor_no, FREQ_SET_EXTERNAL_CONTROL, 0 );
...
void SpiCmdFunc_SearchBasePosition( UB motor_no )
{
 ...
 SetDriveType( motor_no, DRIVE_SEARCH_BASE_POSITION );
    ...
    SetMotorStepCounter( motor_no, 0 );

    SetMotorFrequency( motor_no, FREQ_SET_SELF_CONTROL_SHAKE, 136 );

    SetMotorPositionSearchStart( motor_no );
}
# 348 "spi_control.c"
void SpiCmdFunc_FwdPulseWithCorrect( UB motor_no )
{
...
void SetFwdPulseWithCorrectProc( UB motor_no )
{
 ...
 UpdateTargetPosition( motor_no, 1 );
...
{
 if ( ( 0x01 + 0x02 )== handPositionActiveBit ) {
